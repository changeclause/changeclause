## ChangeClause result: PASS

Head: `da0936e5b0cd74d7dea29aef72b544750d9ee2a6` · Approved baseline: `d93bb6b5e87757392292d74ff7021f480a13d66d`

| Check | Expected for this demonstration | Observed |
| --- | --- | --- |
| Behavior tests | 3 passed, exit 0 | 3/3 passed, exit 0 |
| ChangeClause contract | PASS | PASS, exit 0 |
...
| no-auth-boundary | PASS | No matching fact within the declared extraction capability. |
